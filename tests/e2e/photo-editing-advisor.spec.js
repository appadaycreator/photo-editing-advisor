...
const SVC_URL = "https://appadaycreator.com/photo-editing-advisor/";
const SVC_NAME = "写真・動画編集ソフト選び診断";

test.describe("写真・動画編集ソフト選び診断 - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("photo-editing-advisor");
